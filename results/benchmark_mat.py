...
for j in range(len(mat_file_list)):
    ...
    time_df.to_csv('time_mat.csv', index=False, float_format='%.3f')
    roc_df.to_csv('roc_mat.csv', index=False, float_format='%.3f')
    prn_df.to_csv('prc_mat.csv', index=False, float_format='%.3f')
    ap_df.to_csv('ap_mat.csv', index=False, float_format='%.3f')